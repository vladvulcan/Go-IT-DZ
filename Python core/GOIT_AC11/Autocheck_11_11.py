...
class Iterable:
    def __init__(self, max_vectors, max_points):
        ...
        self.vectors = randrange(max_vectors)
        self.max_points = max_points
            

    def __next__(self):
        if self.current_index < self.vectors:
            self.current_index += 1
            randomX, randomY = randrange(self.max_points), randrange(self.max_points)
            return Vector(Point(randomX, randomY))
